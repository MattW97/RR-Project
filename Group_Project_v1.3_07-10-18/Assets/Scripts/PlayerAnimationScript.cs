	...
	void Update ()
    {
        ...
        else
        {
            ...
            if (weapon.weaponSelection == WeaponScript.WeaponType.BaseballBat)
            {
                ...
                if (playerController.Player.GetAxis("Attack") > 0 && animator.GetCurrentAnimatorStateInfo(1).IsName("BaseballBatMovementBlendTree"))
                {
                    animator.ResetTrigger("AttackTrigger");
                    animator.SetTrigger("AttackTrigger");
            ...
            {               
                ...
                if (playerController.Player.GetAxis("Attack") > 0 && animator.GetCurrentAnimatorStateInfo(3).IsName("MacheteMovementBlendTree"))
                {
                    animator.ResetTrigger("AttackTrigger");
                    animator.SetTrigger("AttackTrigger");
